...
public class Robot extends TimedRobot {
  ...
  static private double GEARING = 18.75;
  static private double kRight = -1;
  static private double kLeft = 1;
    ...
    switch (side) {
      ...
      case RIGHT:
        ...
        rightEncoderPosition = ()
          -> encoder.getPosition() * encoderConstant * kRight;
        rightEncoderRate = ()
          -> encoder.getVelocity() * encoderConstant * kRight / 60.;

        break;
      case LEFT:
        leftEncoderPosition = ()
          -> encoder.getPosition() * encoderConstant * kLeft;
        leftEncoderRate = ()
          -> encoder.getVelocity() * encoderConstant * kLeft / 60.;
  ...
  public void robotInit() {
    ...
    // create left motor
    CANSparkMax leftMotor = setupCANSparkMax(32, Sides.LEFT, true);

    CANSparkMax leftFollowerID31 = setupCANSparkMax(31, Sides.FOLLOWER, true);
    leftFollowerID31.follow(leftMotor, false);
        
    
    CANSparkMax leftFollowerID30 = setupCANSparkMax(30, Sides.FOLLOWER, true);
    leftFollowerID30.follow(leftMotor, false);
        
    

    CANSparkMax rightMotor = setupCANSparkMax(35, Sides.RIGHT, true);
    CANSparkMax rightFollowerID34 = setupCANSparkMax(34, Sides.FOLLOWER, true);
    rightFollowerID34.follow(rightMotor, false);
    CANSparkMax rightFollowerID33 = setupCANSparkMax(33, Sides.FOLLOWER, true);
    rightFollowerID33.follow(rightMotor, false);
